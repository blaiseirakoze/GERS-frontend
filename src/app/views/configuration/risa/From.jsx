...
const Form = () => {
  ...
  useEffect(() => {
    getRoles();
    if (location?.pathname === `/configuration/risa/update/${user?.id}`) {
      setState({
        ...state,
  ...
  return (
    <Container>
      <Box className="breadcrumb">
        <Breadcrumb
          routeSegments={[
            { name: "Configuration", path: "/configuration/risa" },
            { name: "Risa", path: "/configuration/risa" },
            { name: "form" },
          ]}
        />
      </Box>
      <Stack spacing={3}>
        <SimpleCard title={isUpdate ? "Update risa user" : `Create risa user`}>
          {alert?.error ? (
            <Alert
              onClose={handleClose}
              sx={{ m: 1 }}
          ...
          <div>
            ...
            >
              ...
              <div className="text-end">
                <Button
                  onClick={() => navigate("/configuration/risa")}
                  color="primary"
                  variant="outlined"
                  type="button"
                >
