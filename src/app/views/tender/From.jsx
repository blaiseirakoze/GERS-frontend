...
const BasicForm = () => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            setAlert({ ...alert, error: true, message: error?.response?.data?.message })
        }
    };
    ...
    useEffect(() => {
        ...
        getRequests();
        setSelectedRequest({ label: location?.state?.title, value: location?.state?.id });
    }, []);
    ...
    return (
        <Container>
            <Box className="breadcrumb">
                <Breadcrumb routeSegments={[{ name: "Create", path: "/tenders" }, { name: "form" }]} />
            </Box>
            <Stack spacing={3}>
                <SimpleCard title={isUpdate ? "Update Tender" : `Create Tender`} padding={'20px 24px 80px 24px'}>
                    {alert?.error ?
                    ...
                    <Stack spacing={3}>
                        <SimpleCard title={"Tender Information"} padding={'20px 24px 80px 24px'}>
                            ...
                            <Grid container spacing={1}>
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12} >
                                    <label htmlFor="">Open Date <span className='text-danger'>*</span></label>
                                    <TextField
                                        type="date"
                                        name="openDate"
                                        label=""
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12} >
                                    <label htmlFor="">Close Date <span className='text-danger'>*</span></label>
                                    <TextField
                                        type="date"
                                        name="closeDate"
                                        label=""
                        ...
                        <SimpleCard title={"Tender Required Documents"} padding={'20px 24px 80px 24px'}>
                                        ...
                                        map((doc, index) => (
                                            <TableRow key={index}>
                                                ...
                                                <TableCell align="right">
                                                    <IconButton onClick={() => { }}>
                                                        <Icon title="more details" color="danger">delete</Icon>
                                                    </IconButton>
                                                </TableCell>
                                            </TableRow>
                                        ))}
